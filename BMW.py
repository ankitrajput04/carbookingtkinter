...
path="C:/Users/HH/Downloads/BMW M4.jpeg"
img=ImageTk.PhotoImage(Image.open(path))

l1 = Label(top,text='BMW M4 Competition>',fg='black',bg='blue',font=('Arial 10 bold'))
l1.place(x=240,y=170)

l2 = Label(top,text='5 Star Safety|9 kmpl|523 bhp',fg='black',bg='white',font=('Arial 7 bold'))
l2.place(x=240,y=210)

l3 = Label(top,text='Rs. 1.53 Croreonwards',fg='black',bg='white',font=('Arial 7 bold'))
...
path="C:/Users/HH/Downloads/BMW 7 Series.jpeg"
img1=ImageTk.PhotoImage(Image.open(path))

l1 = Label(top,text='BMW 7 Series>',fg='black',bg='blue',font=('Arial 10 bold'))
l1.place(x=680,y=170)

l2 = Label(top,text='12-16 kmpl|281-375 bhp',fg='black',bg='white',font=('Arial 7 bold'))
l2.place(x=680,y=210)

l3 = Label(top,text='Rs. 1.82 Croreonwards',fg='black',bg='white',font=('Arial 7 bold'))
...
path="C:/Users/HH/Downloads/BMW Z4.jpeg"
img2=ImageTk.PhotoImage(Image.open(path))

l1 = Label(top,text='BMW Z4>',fg='black',bg='yellow',font=('Arial 10 bold'))
l1.place(x=1110,y=170)

l2 = Label(top,text='5 Star Safety|12 kmpl|335 bhp',fg='black',bg='white',font=('Arial 7 bold'))
l2.place(x=1110,y=210)

l3 = Label(top,text='Rs. 90.90 Lakhonwards',fg='black',bg='white',font=('Arial 7 bold'))
...
path="C:/Users/HH/Downloads/BMW XM.jpeg"
img3=ImageTk.PhotoImage(Image.open(path))

l1 = Label(top,text='BMW XM>',fg='black',bg='brown',font=('Arial 10 bold'))
l1.place(x=240,y=500)

l2 = Label(top,text='61 kmpl|483 bhp',fg='black',bg='white',font=('Arial 7 bold'))
l2.place(x=240,y=540)

l3 = Label(top,text='Rs. 2.60 Croreonwards',fg='black',bg='white',font=('Arial 7 bold'))
